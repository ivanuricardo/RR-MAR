...
heatmap!(ax1, tuckest.U[2] * tuckest.U[2]', colormap=:PuBu)
...
heatmap!(ax2, tuckest.U[1] * tuckest.U[1]', colormap=:PuBu)
...
heatmap!(ax3, tuckest.U[4] * tuckest.U[4]', colormap=:PuBu)
...
heatmap!(ax4, tuckest.U[3] * tuckest.U[3]', colormap=:PuBu)
